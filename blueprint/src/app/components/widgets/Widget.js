 ...
 */
export function Widget({ staticRender, id, x, y, width, height, isSelected, isMoving, rotation, style = {}, onClick, alertDragStop, children, pointerEventsNone, onDragStart, onDragStop, scale }) {
   ...
   * Return the Rnd and the div if it is in the canvas page. If
   * html is currently being exported, just return the div.
   */
  if (!staticRender) {
    return (
      <Rnd

 ...
 * the widget itself.
 */
export function Widget({ id, x, y, width, height, isSelected, isMoving, rotation, style = {}, onClick, alertDragStop, children, pointerEventsNone, onDragStart, onDragStop, scale, recordState, opacity, borderWidth, borderColor, borderStyle, useOuterBorderFrame, }) {
